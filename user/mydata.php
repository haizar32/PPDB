                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="nisn" id="nisn" type="text" class="form-control" placeholder="NISN" maxlength="10 " value="<?php echo $ambil['nisn']?>" disabled >
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>NIK* (sesuaikan dengan akte kelahiran/ijazah)</label>
                                        <input name="nik" type="text" class="form-control" placeholder="NIK" maxlength="16" value="<?php echo $ambil['nik']?>" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="namalengkap" type="text" class="form-control" placeholder="Nama Lengkap" maxlength="50" value="<?php echo $ambil['namalengkap']?>" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="tempatlahir" type="text" class="form-control" placeholder="Tempat Lahir" maxlength="20" value="<?php echo $ambil['tempatlahir']?>" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tempattinggal" >
                                            <option selected value="<?php echo $ambil['tempattinggal']?>">Terpilih: <?php echo $ambil['tempattinggal']?></option>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="statuskeluarga" >
                                            <option selected value="<?php echo $ambil['statuskeluarga']?>">Terpilih: <?php echo $ambil['statuskeluarga']?></option>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="anakke" class="form-control" >
                                            <option selected value="<?php echo $ambil['anakke']?>">Terpilih: <?php echo $ambil['anakke']?></option>
                                            <?php for ($i = 1; $i <= 12; $i++): ?>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="jumlahsaudara" class="form-control" >
                                            <option selected value="<?php echo $ambil['jumlahsaudara']?>">Terpilih: <?php echo $ambil['jumlahsaudara']?></option>
                                            <?php for ($i = 1; $i <= 12; $i++): ?>
                                                <option value="<?= $i ?>"><?= $i ?></option>
                                            <?php endfor; ?>
                                        </select>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="hobi" >
                                            <option selected value="<?php echo $ambil['hobi']?>">Terpilih: <?php echo $ambil['hobi']?></option>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="citacita" >
                                            <option selected value="<?php echo $ambil['citacita']?>">Terpilih: <?php echo $ambil['citacita']?></option>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="paud" >
                                            <option selected value="<?php echo $ambil['paud']?>">Terpilih: <?php echo $ambil['paud']?></option>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tk" >
                                            <option selected value="<?php echo $ambil['tk']?>">Terpilih: <?php echo $ambil['tk']?></option>
                                            <option value="Pernah">Pernah</option>
                                            <option value="Tidak_Pernah">Tidak Pernah</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="agama" >
                                            <option selected value="<?php echo $ambil['agama']?>">Terpilih: <?php echo $ambil['agama']?></option>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="telepon" type="text" class="form-control" maxlength="15" pattern="\d{10,15}" title="Nomor telepon harus terdiri dari 10-15 angka" value="<?php echo $ambil['telepon']?>" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="market-status-table mt-4">
                        <div class="table-responsive" style="overflow-x:hidden;">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jaraksekolah" >
                                            <option selected value="<?php echo $ambil['jaraksekolah']?>">Terpilih: <?php echo $ambil['jaraksekolah']?></option>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="transportasi" >
                                            <option selected value="<?php echo $ambil['transportasi']?>">Terpilih: <?php echo $ambil['transportasi']?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input name="alamat" type="text" class="form-control" placeholder="Alamat Lengkap" maxlength="255" value="<?php echo $ambil['alamat']?>" disabled>
                            </div>
                        ...
                        <div class="table-responsive" style="overflow-x:hidden;">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="ayahnik" type="text" class="form-control" placeholder="NIK Ayah" maxlength="16" value="<?php echo $ambil['ayahnik']?>" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Nama Ayah*</label>
                                        <input name="ayahnama" type="text" class="form-control" placeholder="Nama Ayah" maxlength="40" value="<?php echo $ambil['ayahnama']?>" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label>NIK Ibu*</label>
                                        <input name="ibunik" type="text" class="form-control" placeholder="NIK Ibu" maxlength="16" value="<?php echo $ambil['ibunik']?>" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Nama Ibu*</label>
                                        <input name="ibunama" type="text" class="form-control" placeholder="Nama Ibu" maxlength="40" value="<?php echo $ambil['ibunama']?>" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="walinik" type="text" class="form-control" placeholder="NIK Wali" maxlength="16" value="<?php echo $ambil['walinik']?>" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Nama Wali</label>
                                        <input name="walinama" type="text" class="form-control" placeholder="Nama Wali" maxlength="40" value="<?php echo $ambil['walinama']?>" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="sekolahnpsn" type="text" class="form-control" placeholder="Nomor Akte" maxlength="16" value="<?php echo $ambil['sekolahnpsn']?>" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Nomor KK</label>
                                        <input name="sekolahnama" type="text" class="form-control" placeholder="No KK" maxlength="16" value="<?php echo $ambil['sekolahnama']?>" disabled>
                                    </div>
                                </div>
                            </div>
